// Script para probar el webhook de Mercado Pago en /api/mercadopago/pagos
const BASE_URL = "https://fn2ck56h-3000.brs.devtunnels.ms"
...
async function testWebhook() {
  const webhookData = {
    type: "payment",
    data: {
      id: "1234567890" // Este ID debería existir en Mercado Pago para que funcione
    }
  }
